...
fn test_different_period_types() {
    ...
    let periods = &["today", "yesterday", "this-week", "last-week", 
                   "this-month", "last-month", "ytd", "last-year"];
